...
class Don(models.Model):
    ...
    nom_entreprise = models.CharField(max_length=50, blank=False,verbose_name="Nom de l'entreprise")
    nom_contact = models.CharField(max_length=50, blank=True,verbose_name='Nom du contact (facultatif), préciser la civilité, exemple : Madame Bidule ou Monsieur Truc')
